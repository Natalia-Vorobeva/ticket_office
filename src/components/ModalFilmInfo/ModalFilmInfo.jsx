					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							...
							<div>
								...
								{/* Убрали строку "Подробное описание" */}
							</div>
						</div>
						...
						<div className="flex-1">
							<div className="mb-6">
								...
								<div className="flex flex-wrap gap-2 mb-4">
									<span className="px-3 py-1 bg-gray-700 text-gray-200 text-xs font-medium rounded">Фантастика</span>
									<span className="px-3 py-1 bg-gray-700 text-gray-200 text-xs font-medium rounded">Боевик</span>
									<span className="px-3 py-1 bg-gray-700 text-gray-200 text-xs font-medium rounded">16+</span>
									<span className="px-3 py-1 bg-gray-700 text-gray-200 text-xs font-medium rounded">2ч 15мин</span>
								</div>
							</div>
